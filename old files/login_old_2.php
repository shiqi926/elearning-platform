...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid main" id="app">
            ...
            <div id="smallScreen">
                <div class="container nes-container is-rounded shadow-lg mx-auto" id="container">

                    <div class="form-container sign-in-container-sm" id="signInContainerSM">
                    ...
                    <div class="form-container sign-up-container-sm" id="signUpContainerSM">
            ...
            <div class="row" id="medScreen">
                ...
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="container nes-container is-rounded shadow-lg mx-auto" id="containerMed">
                        ...
                        <form action="./login_process.php" method="post">
                                <h1>Sign in</h1>
                                <br>
                                <input type="text" class="form-control nes-input mb-3" name="username" placeholder="Username" required="required" value="<?php echo $username;?>">
                                <input type="password" class="form-control nes-input" name="password" placeholder="Password" required="required"/>
                                <br>
                                <a href="#">Forgot your password?</a>
                                <br>
        ...
        <script>
            var vm = new Vue ({
                ...
                methods: {
                    showSignUp: function() {
                        containerMed.classList.add('right-panel-active');
                    },
                    showSignIn: function() {
                        containerMed.classList.remove('right-panel-active');
                    },
                    showSignUpSM: function() {
                        $(signUpContainerSM).css('z-index',3);
                        $(container).css('height','90vh');
                    },
                    showSignInSM: function() {
                        $(signUpContainerSM).css('z-index',1);
                        $(container).css('height','75vh');
                    },
                    formError: function(){
