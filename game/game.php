...
<body>
    ...
    <!-- GAME -->
    <div class="bg-game" id="home">
                <!-- game adapted from https://codepen.io/punkydrewster713/pen/WNrXPrb -->
                <div class="frame">  
    ...
    <!-- Optional JavaScript adapted from https://codepen.io/punkydrewster713/pen/WNrXPrb  -->
